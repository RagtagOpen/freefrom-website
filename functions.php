	...
	if ( class_exists( 'WP_Block_Patterns_Registry' ) ) {
		...
		register_block_pattern(
			...
			array(
				...
				'content'     => "<!-- wp:group {\"className\":\"featured-cta-bottom\"} --><div class=\"wp-block-group featured-cta-bottom\"><div class=\"wp-block-group__inner-container\"><!-- wp:group {\"backgroundColor\":\"pink\",\"textColor\":\"black\"} -->\n<div class=\"wp-block-group has-black-color has-pink-background-color has-text-color has-background\"><div class=\"wp-block-group__inner-container\"><!-- wp:image {\"sizeSlug\":\"large\",\"linkDestination\":\"none\"} -->\n<figure class=\"wp-block-image size-large\"><img src=\"https://picsum.photos/771\" alt=\"\"/></figure>\n<!-- /wp:image -->\n\n<!-- wp:heading {\"level\":3} -->\n<h3>Survivors know best</h3>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p>How to disrupt intimate partner violence during COVID-19 and beyond</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:buttons {\"contentJustification\":\"right\"} -->\n<div class=\"wp-block-buttons is-content-justification-right\"><!-- wp:button {\"textColor\":\"black\",\"className\":\"is-style-outline\"} -->\n<div class=\"wp-block-button is-style-outline\"><a class=\"wp-block-button__link has-black-color has-text-color\"><strong>Read our report</strong></a></div>\n<!-- /wp:button --></div>\n<!-- /wp:buttons --></div></div>\n<!-- /wp:group --></div></div><!-- /wp:group -->",
				'categories'  => array('freefrom')
			)
		);
		...
		register_block_pattern(
			...
			array(
				...
				'content'     => "<!-- wp:group {\"className\":\"impact-statement\"} --><div class=\"wp-block-group impact-statement\"><div class=\"wp-block-group__inner-container\"><!-- wp:group {\"backgroundColor\":\"teal\"} -->\n<div class=\"wp-block-group has-teal-background-color has-background\"><div class=\"wp-block-group__inner-container\"><!-- wp:columns -->\n<div class=\"wp-block-columns\"><!-- wp:column -->\n<div class=\"wp-block-column\"><!-- wp:paragraph {\"style\":{\"typography\":{\"fontSize\":52}},\"textColor\":\"black\"} -->\n<p class=\"has-black-color has-text-color\" style=\"font-size:52px\"><strong>GET CASH DIRECTLY TO SURVIVORS</strong></p>\n<!-- /wp:paragraph -->\n\n<!-- wp:buttons -->\n<div class=\"wp-block-buttons\"><!-- wp:button {\"backgroundColor\":\"yellow\"} -->\n<div class=\"wp-block-button\"><a class=\"wp-block-button__link has-yellow-background-color has-background\">Donate</a></div>\n<!-- /wp:button --></div>\n<!-- /wp:buttons --></div>\n<!-- /wp:column -->\n\n<!-- wp:column -->\n<div class=\"wp-block-column\"><!-- wp:paragraph {\"style\":{\"typography\":{\"fontSize\":24}},\"textColor\":\"black\"} -->\n<p class=\"has-black-color has-text-color\" style=\"font-size:24px\">The cash came just in time to fix my car.  Not having a vehicle makes it difficult to get groceries (I use EBT so I can\'t order online). [...] So, the timing of this grant was a huge relief!</p>\n<!-- /wp:paragraph --></div>\n<!-- /wp:column --></div>\n<!-- /wp:columns --></div></div>\n<!-- /wp:group --></div></div><!-- /wp:group -->",
				'categories'  => array('freefrom')
			)
		);
